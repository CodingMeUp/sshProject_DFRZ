...
<script language="javascript">
	...
	jQuery(function(){
		...
		jQuery("#role_menu_div").tree({
			url:				"<%=path%>/roleAction!loadMenuTree?role_id="+role_id+"&date="+new Date()+"",
			method:				"GET",
			lines:				true ,
			checkbox:			true
		}); 	
...
function saveRole(){
	...
	var saveURL = "<%=path%>/roleAction!modify?date="+new Date()+"";
...
<form action="" id="form1">
	<table border="0" width="100%" style="font-family: '新宋体';font-size: 13px;">
		<tr height="25px;">
			...
			<td width="40%" align="left"><s:textfield name="role_id" id="role_id" readonly="true" cssClass="easyui-numberbox"  data-options="min:1,max:999"/>
			</td>
		</tr>
		<tr height="25px;">
