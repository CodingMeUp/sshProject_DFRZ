...
<body>
	<form action="<%=path%>/noticeAction!update" id="form1" enctype="multipart/form-data" method="post">
			...
			<tr height="25px;">
				...
				<td align="left" width="70%">
					<script id="notice_content" name="notice_content" type="text/plain" 
							style="width:100%;">${notice_content}</script>
				</td>
			...
			<tr height="25px;">
				...
				<td align="left">
					...
					<s:if test="filename != null">
						原先上传的附件:<s:property value="filename"/>
					</s:if>
				</td>
